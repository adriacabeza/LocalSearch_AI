...
Using some of the same scenarios as before, we repeat the experiments this time with Simulated Annealing.
...
We have obtained the following parameters for the Simulated Annealing:
...
\begin{figure}[H]
  \captionsetup{justification=centering}
   \centering
    \includegraphics[scale=0.8]{Results/BLA.pdf}
      \caption{BLABLA}
      \label{fig:BLABLA}
  \end{figure}
    \vspace{1cm}
